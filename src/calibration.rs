...
pub(crate) fn run_calibration<SPI, SPIError, IRQ, IRQError, DT, DELAY>(
...
pub fn estimate_calibration(
    ...
    let mut calibration_data = CalibrationData {
        alpha_x: display_width as f32 / TOUCH_SIZE,
        beta_x: 0.0,
        delta_x: 0.0,
        alpha_y: 0.0,
        beta_y: display_height as f32 / TOUCH_SIZE,
        delta_y: 0.0,
    };
    ...
    if mirror_x {
        ...
        calibration_data.delta_x += display_width as f32;
    }
    if mirror_y {
        calibration_data.alpha_y *= -1.0;
        calibration_data.beta_y *= -1.0;
        calibration_data.delta_y *= -1.0;
        calibration_data.delta_y += display_height as f32;
    }
...
pub const fn get_builtin_calibration(orientation: Orientation) -> CalibrationData {
    match orientation {
